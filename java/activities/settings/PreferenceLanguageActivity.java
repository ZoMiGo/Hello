public class PreferenceLanguageActivity extends AppCompatActivity {
    ...
    @BindView(R.id.indicator_portugise)
    TextView indicatorPortugise;
    ...
    @BindView(R.id.portugise_btn)
    LinearLayout PortugiseBtn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PortugiseBtn.setOnClickListener(view -> {
            if (indicatorPortugise.getVisibility() == View.GONE) {
    ...
    public void loadLocale() {
        ...
        switch (language) {
            case "fr":
                ...
                indicatorPortugise.setVisibility(View.GONE);
                break;
            case "en":
            ...
            case "phi":
                ...
                break;
            case "pt":
                indicatorPortugise.setVisibility(View.VISIBLE);
                indicatorFilipino.setVisibility(View.GONE);
                indicatorChinese.setVisibility(View.GONE);
                indicatorHindi.setVisibility(View.GONE);
                indicatorSlovenisch.setVisibility(View.GONE);
